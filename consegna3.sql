...
CREATE TABLE ESPOSITORE ( 
    ...
    Stand INT,
    Anno_Edizione INT,
    Tipologia ENUM("ACCADEMIA","AZIENDA"),
...
DELIMITER $
CREATE TRIGGER Switch
AFTER INSERT ON ESPOSITORE
FOR EACH ROW BEGIN
	IF(NEW.Tipologia = "ACCADEMIA") THEN
			INSERT INTO ACCADEMIA(CF_Espositore) VALUES (NEW.CF);
	ELSE 
		INSERT INTO AZIENDA(CF_Espositore) VALUES (NEW.CF);
	END IF;
END;
$ DELIMITER ;
...
INSERT INTO ESPOSITORE(CF, Email, Stand, Anno_Edizione, Tipologia) VALUES ("LNLMOL00L99C123W", "ciaociao@mail.it", 2, 2021, "ACCADEMIA");
